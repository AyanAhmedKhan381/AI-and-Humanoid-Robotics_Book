    ...
    <section className={styles.hero}>
      <div className={styles.heroContent}>
        ...
        <p className={styles.heroSubtitle}>
          Bridge the digital and physical worlds.<br />
          Learn to design, simulate, and deploy intelligent robotic systems that think, move, and interact.
        </p>
  ...
  return (
    <section className={styles.features}>
      <div className={styles.sectionHeader}>
        ...
        <p>Learn through immersive modules and AI-assisted guidance</p>
      </div>
